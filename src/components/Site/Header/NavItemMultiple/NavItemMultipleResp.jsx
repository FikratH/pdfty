...
import DropdownSmallResp from "../DropdownSmall/DropdownSmallResp";
import DropdownLargeResp from "../DropdownLarge/DropdownLargeResp";
import { Link } from "react-router-dom";

const NavItemMultipleResp = ({ linkto, text }) => {
  ...
  return (
    ...
    >
      ...
      {isClicked ? <DropdownSmallResp /> : ""}
    </li>
  );
};

export default NavItemMultipleResp;
